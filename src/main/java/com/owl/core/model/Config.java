...
public class Config {
    ...
    private long upOutTime;

    private long dubboOutTime;

    public long getKillOutTime() {
        return killOutTime;
    }

    public void setKillOutTime(long killOutTime) {
        this.killOutTime = killOutTime;
    }

    public long getUpOutTime() {
        return upOutTime;
    }

    public void setUpOutTime(long upOutTime) {
        this.upOutTime = upOutTime;
    }

    public long getDubboOutTime() {
        return dubboOutTime;
    }

    public void setDubboOutTime(long dubboOutTime) {
        this.dubboOutTime = dubboOutTime;
    }
